...
echo "  SSH_PROXY_CLIENT_SECRET: ${SSH_PROXY_CLIENT_SECRET:0:8}..."
echo "  JAVA_AGENTS_CLIENT_SECRET: ${JAVA_AGENTS_CLIENT_SECRET:0:8}..."
echo "  MONITORING_AGENT_CLIENT_SECRET: ${MONITORING_AGENT_CLIENT_SECRET:0:8}..."
echo "  SSH_AGENT_CLIENT_SECRET: ${SSH_AGENT_CLIENT_SECRET:0:8}..."
echo "  SENTRIUS_RDPPROXY_CLIENT_SECRET: ${SENTRIUS_RDPPROXY_CLIENT_SECRET:0:8}..."
echo "  PROMPT_ADVISOR_CLIENT_SECRET: ${PROMPT_ADVISOR_CLIENT_SECRET:0:8}..."
