...
public class CommandCategorizer {
    ...
    private final Cache<String, CommandCategoryDTO> commandCache = Caffeine.newBuilder()
        .maximumSize(1000)
    ...
    protected CommandCategoryDTO categorizeWithRulesOrML(String command) {
        ...
        return CommandCategoryDTO.builder().build();
    }

    private void addCommandCategory(String pattern, CommandCategoryDTO category) {
        commandCategoryRepository.save(CommandCategory.fromDTO(category));
