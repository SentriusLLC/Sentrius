...
import io.sentrius.sso.automation.sideeffects.state.StateTrackingFunction;
import io.sentrius.sso.callbacks.OutputCallback;
import io.sentrius.sso.core.model.Host;
import io.sentrius.sso.rollback.RollbackFunction;
...
public interface AutomationPlugin {
   ...
   * @throws java.security.GeneralSecurityException If there is a security-related error.
