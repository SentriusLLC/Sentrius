...
AI_AGENT_ASSESSOR_CLIENT_SECRET=$(get_or_generate_secret "$KEYCLOAK_SECRET" "AI_AGENT_ASSESSOR_CLIENT_SECRET" "AI_AGENT_ASSESSOR_CLIENT_SECRET" 32)
...
AI_AGENT_ASSESSOR_CLIENT_SECRET=${AI_AGENT_ASSESSOR_CLIENT_SECRET}
